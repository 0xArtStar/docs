...
ArtStar 采用 [ERC-20](https://ethereum.org/zh/developers/docs/standards/tokens/erc-20/) 标准作为资产代币化的基础协议。
...
- [ERC-20 Standard](https://ethereum.org/zh/developers/docs/standards/tokens/erc-20/)
